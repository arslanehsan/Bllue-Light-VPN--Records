...
class SSRDetailsDialog extends StatefulWidget {
  final SSRObject singleSSRItem;

  const SSRDetailsDialog({super.key, required this.singleSSRItem});

  @override
  State<StatefulWidget> createState() => SSRDetailsDialogState();
}

class SSRDetailsDialogState extends State<SSRDetailsDialog>
  ...
  late final SSRObject _ssr = widget.singleSSRItem;

  @override
  void initState() {
    super.initState();

    _addressEdtController.text = _ssr.address!;
    _portEdtController.text = _ssr.port!;
    _passwordEdtController.text = _ssr.password!;
    _remarksEdtController.text = _ssr.remarks!;
          ...
          child: Container(
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  const Text(
                    AppConstantsEnglish.categoryFour,
                    style: TextStyle(
